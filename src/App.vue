<template>
  <header>
    <span class="title-via">via</span>
    <span class="title-cep">CEP</span>
  </header>
  <div class="container">
    ...
    <section class="via-cep-box" v-if="cepTableActived">
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              <button class="action-button" @click="toDeleteCep">Deletar</button>
            </td>
          </tr>
        </tbody>
      </table>
      <div class="cep-delete-notification-box" v-if="cepIsDeleted">
        <div class="cep-delete-notification">
          ...
          <div id="item-two"><button id="item-two-button" @click="toUndoDeletedCep">Desfazer</button></div>
        </div>
      </div>
    </section>
  </div>
